  (function() {
    ...
    for (var i = 0; i < 100; i++) { // Create 100 animations
      ...
      } while ((rotation === lastRotation || rotation === nextRotation) && 
      ...
      timeline.set(element, {
        ...
        width: rotation % 180 === 0 ? '100%' : '141.42%',
        height: rotation % 180 === 0 ? '100%' : '141.42%',
      });
